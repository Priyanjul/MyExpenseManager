    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.Share:
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, title.getText().toString().trim());
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, note.getText().toString().trim());
